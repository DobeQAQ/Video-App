...
public class MyLikeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyLikeAdapter(Context context, List<VideoEntity> datas) {
        this.mContext = context;
        this.datas = datas;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.my_like_video_layout, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(@NonNull View view) {
            super(view);
            tvTitle = view.findViewById(R.id.like_title);
            tvAuthor = view.findViewById(R.id.like_author);
            imgHeader = view.findViewById(R.id.like_img_header);
            mPlayerContainer = view.findViewById(R.id.like_player_container);
            mPrepareView = view.findViewById(R.id.like_prepare_view);
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.like_player_container) {
                if (mOnItemChildClickListener != null) {
